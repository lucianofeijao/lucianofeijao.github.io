...
<h1 class="${"svelte-1tf582o"}">Great success!</h1>

<figure class="${"svelte-1tf582o"}"><img alt="${"Success Kid"}" src="${"successkid.jpg"}" class="${"svelte-1tf582o"}">
	<figcaption>Have fun with Sapper!</figcaption></figure>

<p class="${"svelte-1tf582o"}"><strong>Try editing this file (src/routes/index.svelte) to test live reloading.</strong></p>
${each(images, ({ slug, sizes, extension }) => `<img alt="${""}" src="${"images/" + escape(slug) + "-180_x2." + escape(extension)}" class="${"svelte-1tf582o"}">`)}`;
});
...
const manifest = {
	...
	pages: [
...

		{
			...
			pattern: /^\/work\/?$/,
			parts: [
				{ name: "work", file: "work.svelte", component: Work }
			]
		}
	],
