...
<h1 class="${"svelte-1jidkdt"}">Great success!</h1>

<figure class="${"svelte-1jidkdt"}"><img alt="${"Success Kid"}" src="${"successkid.jpg"}" class="${"svelte-1jidkdt"}">
	<figcaption>Have fun with Sapper!</figcaption></figure>

<p class="${"svelte-1jidkdt"}"><strong>Try editing this file (src/routes/index.svelte) to test live reloading.</strong></p>
${each(images, ({ slug, sizes, extension, srcset }) => `<img alt="${""}" data-sizes="${"auto"}"${add_attribute("data-srcset", srcset, 0)} class="${"big lazyload svelte-1jidkdt"}">`)}`;
});
